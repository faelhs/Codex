...
//Heuristic Detector by Classname
	carrega.Detecta_Heuristica_Class	= 0;     // On/Off - Detect bad Words, are case sensitive and scan WebBrowsers
...
//Virtual Memory Protection
	...
	carrega.Virtual_Mem_occours         = 735;   // Occours every X miliseconds. [ ATENTION! If antikill by Scans active this value canot be more than 1000 ]
